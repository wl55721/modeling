...
def build_op_graph(records: List[Dict[str, Any]]) -> nx.DiGraph:
    ...
    -------
    nx.DiGraph
        A DAG where each node ID is the op index (``rec["idx"]``) and
