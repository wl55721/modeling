...
_EXACT_FORMULAS: dict[str, "callable"] = {
    ...
    "aten.square.default":              _elementwise,
    ...
    "aten.var.default":                 lambda n: _elementwise(n, 3.0),
    "aten.std.correction":              lambda n: _elementwise(n, 3.0),
    "aten.std.default":                 lambda n: _elementwise(n, 3.0),
