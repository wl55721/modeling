...
RAW_DATA_HEADERS = [
    ...
    "moe_fb_overlap", "dualbatch", "dp_overlap_in_bubble", "recompute", "optimizer", "quant_preset",
...
def _make_strategy_from_config(config: Dict) -> Strategy:
    ...
    return Strategy(
        ...
        moe_fb_overlap=config.get("moe_fb_overlap", False),
...
class TrainingConfigManager:
    ...
    def _build_strategy_for_validation(
        ...
        return Strategy(
            ...
            moe_fb_overlap=other_config.get("moe_fb_overlap", False),
