...
def _estimate_legacy(
    ...
    return TrainingReport(
        ...
        ep_fb_total_ms=s.ep_fb_total * 1000,
        ep_fb_hidden_ms=s.ep_fb_hidden * 1000,
        ep_fb_exposed_ms=s.ep_fb_exposed * 1000,
        ep_fb_steady_hidden_ms=s.ep_fb_steady_hidden * 1000,
        ep_fb_boundary_hidden_ms=s.ep_fb_boundary_hidden * 1000,
        mega_moe_hidden_ms=s.mega_moe_hidden * 1000,
